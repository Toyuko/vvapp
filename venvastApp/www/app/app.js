...
var app = angular.module('starter', ['ionic', 'ngCordova'])
    ...
    .provider('ionicDatePicker', function () {
        ...
        var config = {
            ...
            monthsList: ["January 2016", "February 2016", "March 2016", "April 2016", "May 2016", "June 2016", "July 2016", "August 2016", "September 2016", "October 2016", "November 2016", "December 2016"],
            templateType: 'popup',
        ...
        this.$get = ['$rootScope', '$ionicPopup', '$ionicModal', 'IonicDatepickerService', function ($rootScope, $ionicPopup, $ionicModal, IonicDatepickerService) {
            ...
            //goto date: today, tomorrow and weekend
            $scope.gotoDate = function (type) {
                ...
                $scope.dateSelected({epoch: Number(date.format('x'))});
                refreshDateList(date.toDate());
            };
